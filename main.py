...
class Consumer:
    ...
    def agt_step(self):
        ...
        if applying_store != None:
            ...
            self.wanted_mask_number = 50 * (self.wanted_mask_number // 50)
...
class Store:
    def __init__(self, universe):
        ...
        self.universe = universe
        self.initial_mask_number = round(universe.all_supply / universe.store_number * max(gauss(1, 0.2), 1))
        self.posessing_mask_number = self.initial_mask_number

    def agt_init(self):
        self.request_information = []
        self.initial_mask_number = self.posessing_mask_number
